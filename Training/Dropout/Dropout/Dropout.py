...
dropouts = [0, 0.025, 0.05, 0.075, 0.1, 0.125, 0.15, 0.175, 0.2, 0.225, 0.25, 0.275, 0.3]

for rnndropout in dropouts:
    for densedropout in dropouts:
        param = dict(og_param)
        param['dropout'] = densedropout
        param['rnn_dropout'] = rnndropout
